        ...
        <?php } else { ?>
            <form action="index.php" method="POST">
                <div class="form-group">
                    ...
                    <input class="form-control"  id="lastName" type="text" name="lastName" value="<?= isset($lastName) ? $lastName : '' ?>" required />
                           <p class="text-danger"><?= isset($formError['lastName']) ? $formError['lastName'] : ''; ?></p>
                    <label for="firstName">Prénom</label>
                    <input class="form-control" id="firstName" type="text" name="firstName" value="<?= isset($firstName) ? $firstName : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['firstName']) ? $formError['firstName'] : ''; ?></p>
                    <label for="dateOfBirth">Date de naissance</label>
                    <input class="form-control" id="dateOfBirth" name="dateOfBirth" value="<?= isset($dateOfBirth) ? $dateOfBirth : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['dateOfBirth']) ? $formError['dateOfBirth'] : ''; ?></p>
                    <label for="countryOfBirth">Pays de naissance</label>
                    <input class="form-control" id="countryOfBirth" type="text" name="countryOfBirth" value="<?= isset($countryOfBirth) ? $countryOfBirth : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['countryOfBirth']) ? $formError['countryOfBirth'] : ''; ?></p>
                    <label for="nationality">Nationalité</label>
                    <input class="form-control" id="nationality" type="text" name="nationality" value="<?= isset($nationality) ? $nationality : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['nationality']) ? $formError['nationality'] : ''; ?></p>
                    <label for="address">Adresse</label>
                    <input class="form-control" id="address" type="text" name="address" value="<?= isset($address) ? $address : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['address']) ? $formError['address'] : ''; ?></p>
                    <label for="mail">Email</label>
                    <input class="form-control" id="mail" type="text" name="mail" value="<?= isset($mail) ? $mail : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['mail']) ? $formError['mail'] : ''; ?></p>
                    <label for="phone">Téléphone</label>
                    <input class="form-control" id="phone" name="phone" value="<?= isset($phone) ? $phone : '' ?>" required />
                    ...
                    <input class="form-control" id="numberPE" name="numberPE" value="<?= isset($numberPE) ? $numberPE : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['numberPE']) ? $formError['numberPE'] : ''; ?></p>
                    <label for="badge">Nombre de badge (facultatif)</label>
                    <input class="form-control" id="badge" name="badge" value="<?= isset($badge) ? $badge : '' ?>" required />
                    <p class="text-danger"><?= isset($formError['badge']) ? $formError['badge'] : ''; ?></p>
                    <label for="codeAca">Liens codecademy (facultatif)</label>
                    <input class="form-control" id="codeAca" type="text" name="codeAca" value="<?= isset($codeAca) ? $codeAca : '' ?>" required />
